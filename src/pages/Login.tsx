...
export function LoginScreen() {
  const { signIn, signUp, enterLocalDemo } = useAuth();
    ...
    <div className="auth-wrap">
      <div className="card auth-card">
        ...
        <div className="row" style={{ gap: 0, marginBottom: 16 }}>
          ...
          <button className={mode === "signup" ? "" : "ghost"} style={{ flex: 1, borderRadius: "0 8px 8px 0" }} onClick={() => setMode("signup")}>Create account</button>
        </div>
